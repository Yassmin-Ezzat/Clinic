...
<body>
    ...
    <div class=ex2>
        <img class=ex2p src="../public/images/booking.png">
    ...
    <div class=ex3>
        <img class=ex3p src="../public/images/records.png">
    ...
    <div class=ex5>
        <img class=ex5p src="../public/images/time.png">
    ...
    <div class=ex6>
        <img class=ex6p src="../public/images/doctor.png">
